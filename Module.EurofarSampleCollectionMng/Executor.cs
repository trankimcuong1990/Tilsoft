...
namespace Module.EurofarSampleCollectionMng
{
    public class Executor : Library.Base.IExecutor
    {
        ...
        public object CustomFunction(int userId, string identifier, Hashtable input, out Notification notification)
        {
            ...
            {
                case "exportexcel":
                    return bll.ExportExcel(input, out notification);
            }
            notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Sample function's identifier not matched" };
            return null;
        }
