        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            switch (identifier.ToLower())
            {
                case "getdata":
                    ...
                    {
                        notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Unknow specification id" };
                        return null;
                    }
                ...
                case "updatecomment":
                    return bll.UpdateComment(userId, input["data"], out notification);
                ...
                case "getfactoryorderdetail":
                    ...
                    {
                        notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Unknow model id" };
                        return null;
                    }

                    return bll.GetFactoryOrderDetail(Convert.ToInt32(input["factoryID"]), Convert.ToInt32(input["modelID"]), input["articleCode"].ToString(), out notification);
            }
