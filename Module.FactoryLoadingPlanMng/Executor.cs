        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            switch (identifier.ToLower())
            {
                ...
                case "searchparent":
                    ...
                    return bll.QuickSearchParentLoadingPlan(userId, input["query"].ToString(), out notification);

                case "searchfactoryorderdetail":
                    if (!input.ContainsKey("factoryid"))
                    {
                        notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Unknow factory" };
                        return null;
                    ...
                    return bll.QuickSearchFactoryOrderDetail(userId, Convert.ToInt32(input["factoryid"]), input["query"].ToString(), out notification);

                case "searchfactoryordersparepartdetail":
                    if (!input.ContainsKey("factoryid"))
                    {
                        notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Unknow factory" };
                        return null;
                    ...
                    return bll.QuickSearchFactoryOrderSparepartDetail(userId, Convert.ToInt32(input["factoryid"]), input["query"].ToString(), out notification);
                ...
                case "getdata":
                    ...
                    {
                        notification = new Library.DTO.Notification() { Type = Library.DTO.NotificationType.Error, Message = "Unknow parentid" };
                        return null;
                    }
                    return bll.GetData(userId, Convert.ToInt32(input["id"]), Convert.ToInt32(input["bookingid"]), Convert.ToInt32(input["factoryid"]), Convert.ToInt32(input["parentid"]), out notification);
            }
