...
tilsoftApp.controller('tilsoftController', ['$scope', function ($scope) {
    ...
    $scope.event = {
        ...
        search: function () {
            if ($scope.filters.Factory == null) {
                $scope.filters.Factory = '';
            }

            if ($scope.filters.FrameMaterialID == null) {
                    ...
                    function (data) {
                        ...
                        if (data.message.type == 0) {
                            ...
                            for (var i = 0; i < $scope.data.length; i++) {
                                if ($scope.data[i].frameMaterialProfileID == data.data) {
                                    j = i;
                                    break;
                                }
                            }
