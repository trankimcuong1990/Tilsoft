...
tilsoftApp.controller('tilsoftController', ['$scope', '$cookieStore', function ($scope, $cookieStore) {
    ...
    $scope.event = {
        reload: function () {
            ...
            jsonService.searchFilter.sortedBy = 'clientNM';
                    ...
                    function (data) {
                        ...
                        if (data.message.type == 0) {
                            ...
                            for (var i = 0; i < $scope.data.length; i++) {
                                if ($scope.data[i].clientOfferID == data.data) {
                                    j = i;
                                    break;
                                }
                            }
        ...
        printReport: function ($event) {
            ...
            jsonService.getReportClientOfferOverview($scope.printFilter.validFrom, $scope.printFilter.validTo,
                function (data) {
