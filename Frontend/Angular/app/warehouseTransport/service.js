var warehouseTransportService = {
    ...
    getEditSupport: function (successCallBack, errorCallBack) {
        jQuery.ajax({
            cache: false,
            headers: {
                'Accept': 'application/json',
            ...
            type: "POST",
            url: this.serviceUrl + 'geteditsupport',
            beforeSend: function () {
                jsHelper.loadingSwitch(true);
            },
            success: function (data) {
    ...
    quickSearchProduct: function (filters, successCallBack, errorCallBack) {
        jQuery.ajax({
            cache: false,
            headers: {
                'Accept': 'application/json',
            ...
            url: this.serviceUrl + 'quicksearchproduct',
            beforeSend: function () {
                jsHelper.loadingSwitch(true);
            },
            success: function (data) {
