(function () {
    ...
    angular.module('tilsoftApp').service('dataService', deliveryNoteToBeDestroyedService);
    deliveryNoteToBeDestroyedService.$inject = ['$http', 'jsonService'];

    function deliveryNoteToBeDestroyedService($http, jsonService) {
