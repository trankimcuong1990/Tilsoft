...
tilsoftApp.controller('tilsoftController', ['$scope', '$cookieStore', 'dataService', function ($scope, $cookieStore, dataService) {
    ...
    $scope.productionItemMaterialTypes = [
        { 'productionItemMaterialTypeID': 1, 'productionItemMaterialTypeNM': 'Material' },
        { 'productionItemMaterialTypeID': 2, 'productionItemMaterialTypeNM': 'Cushion' },
        { 'productionItemMaterialTypeID': 2, 'productionItemMaterialTypeNM': 'Carton Box' }
    ];
    ...
    $scope.event = {
        ...
        search: function (isLoadMore) {
            if ($scope.filters.ProductionItemTypeUD == null) {
                $scope.filters.ProductionItemTypeUD = '';
            }
            if ($scope.filters.ProductionItemTypeNM == null) {
                $scope.filters.ProductionItemTypeNM = '';
            }
