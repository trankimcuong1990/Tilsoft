(function() {
    ...
    angular
        ...
        .controller('tilsoftController', ['$scope', FactoryStockReceiptController]);
    

    function FactoryStockReceiptController($scope) {
        //
        // property
        //
        $scope.filters = {
                    ...
                    function (data) {
                        ...
                        if (data.message.type == 0) {
                            ...
                            for (var i = 0; i < $scope.data.length; i++) {
                                if ($scope.data[i].factoryStockReceiptID == data.data) {
                                    j = i;
                                    break;
                                }
                            }
