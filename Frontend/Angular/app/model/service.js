...
jsonService.getClientData = function (season, clientID, modelID, successCallBack, errorCallBack) {
    ...
    jQuery.ajax({
        ...
        type: "POST",
        url: this.serviceUrl + 'getclientdata?season=' + season + '&clientID=' + clientID + '&modelID=' + modelID,
        beforeSend: function () {
            jsHelper.loadingSwitch(true);
        },
        success: function (data) {
...
jsonService.approveData = function (id, packagingMethodID, data, successCallBack, errorCallBack) {
    debugger;
    jQuery.ajax({
        cache: false,
        headers: {
        ...
        dataType: "json",
        data: JSON.stringify(data),
        url: this.serviceUrl + 'approveData?id=' + id + '&packagingID=' + packagingMethodID ,
        beforeSend: function () {
            jsHelper.loadingSwitch(true);
        },
        success: function (data) {
...
jsonService.selfCalculationPrice = function (id, season, data, successCallBack, errorCallBack) {
    jQuery.ajax({
        cache: false,
        headers: {
            'Accept': 'application/json',
        ...
        dataType: 'json',
        data: JSON.stringify(data),
        url: this.serviceUrl + 'selfcalculationprice?id=' + id + '&season=' + season,
        beforeSend: function () {
            jsHelper.loadingSwitch(true);
        },
        success: function (data) {
