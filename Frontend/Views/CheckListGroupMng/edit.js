        ...
        function activepage() {
            ...
            unitService.load(
                ...
                function (data) {
                    ...
                    $scope.data = data.data.checkListGroupDTO;
                    jQuery("#content").show();
                ...
                unitService.update(              
                    ...
                    function (data) {
                        ...
                        if (data.message.type === 0) {
                            window.location = context.refreshUrl + data.data.checkListGroupDTO.checkListGroupID;
                    ...
                    function (data) {
                            ...
                            if (context.id === 0) {
                                //refresh page
                                var id = data.data.checkListGroupID;
