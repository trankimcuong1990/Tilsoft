...
(function () {
    ...
    function storageCardRptController($scope, $timeout, storageCardRptService) {
        ...
        $scope.totalPurchaseOrderQnt = null;
        $scope.purchaseOrderIDs = '';
        ...
        function search(productionItemID, factoryWarehouseID, startDate, endDate) {
            ...
            storageCardRptService.getDataWithFilters(
                ...
                function (data) {
                    ...
                    $scope.totalPurchaseOrderQnt = data.data.totalPurchaseOrderQnt;
                    $scope.purchaseOrderIDs = data.data.purchaseOrderIDs;
        ...
        function getEndingLatest() {
            ...
            if (sum === 0 && $scope.totalBeginning !== 0) {
