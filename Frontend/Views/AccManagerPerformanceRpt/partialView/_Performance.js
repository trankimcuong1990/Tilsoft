angular.module('tilsoftApp').controller('performanceController', ['$scope', '$rootScope', '$timeout', 'dataService', '$filter', function ($scope, $rootScope, $timeout, dataService, $filter) {
    //
    // property
    //
    $scope.performance = {};
                    ...
                    if (data.message.type === 0) {
                        ...
                        $timeout(function () {
                            ...
                            if ($scope.data.selectedSaleID === -1) {
                                ...
                                angular.forEach($scope.supportData.sales.filter(o => o.userID !== 23), function (sale) {
                                    var deltaSeri = {
