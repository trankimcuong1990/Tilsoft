(function () {
    ...
    function dataService($http, jsonService) {
        ...
        var self = this;
        self.searchFilter.sortedBy = "QAQCID";
        ...
        function getData(id, saleOrderDetailID, factoryID, successCallBack, errorCallBack) {
            jQuery.ajax({
                cache: false,
                headers: {
                    'Accept': 'application/json',
                ...
                type: 'POST',
                url: self.serviceUrl + 'getData?id=' + id + '&saleOrderDetailID=' + saleOrderDetailID + '&factoryID=' + factoryID,
                beforeSend: function () {
                    jsHelper.loadingSwitch(true);
                },
                success: function (data) {
