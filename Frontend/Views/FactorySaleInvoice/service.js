angular.module('tilsoftApp').service('dataService', ['$http', 'jsonService', function ($http, jsonService) {
    ...
    this.getPurchaseOrderData = function (iSuccessCallback, iErrorCallback) {
        ...
        $http({
            ...
            url: this.serviceUrl + 'get-factorysaleorder-data',
    ...
    this.setFactorySaleInvoiceStatus = function (factorySaleInvoiceID, factorySaleInvoiceStatusID, iSuccessCallback, iErrorCallback) {
        jsHelper.loadingSwitch(true);

        $http({
            method: 'POST',
            url: this.serviceUrl + 'set-factorysaleinvoice-status?factorySaleInvoiceID=' + factorySaleInvoiceID + '&factorySaleInvoiceStatusID=' + factorySaleInvoiceStatusID,
