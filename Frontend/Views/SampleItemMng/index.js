...
tilsoftApp.controller('tilsoftController', ['$scope', '$cookieStore', function ($scope, $cookieStore) {
    ...
    $scope.seasonDTOs = null;
    $scope.sampleProductStatusDTOs = null;
    ...
    $scope.event = {
        ...
        init: function () {
            ...
            jsonService.getsearchfilter(
                function (data) {
                    $scope.seasonDTOs = data.data.seasonDTOs;
                    $scope.sampleProductStatusDTOs = data.data.sampleProductStatusDTOs;
