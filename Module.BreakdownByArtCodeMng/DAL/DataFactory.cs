...
namespace Module.BreakdownByArtCodeMng.DAL
{
    internal class DataFactory : Library.Base.DataFactory<DTO.SearchFormData, DTO.EditFormData>
    {
        ...
        private BreakdownByArtCodeMngEntities CreateContext()
        {
            return new BreakdownByArtCodeMngEntities(Library.Helper.CreateEntityConnectionString("DAL.BreakdownByArtCodeMngModel"));
        }
        ...
        public override DTO.SearchFormData GetDataWithFilter(System.Collections.Hashtable filters, int pageSize, int pageIndex, string orderBy, string orderDirection, out int totalRows, out Library.DTO.Notification notification)
        {
            ...
            data.Data = new List<DTO.BreakdownSearchResultDTO>();
            totalRows = 0;
            ...
            {
                ArticleCode = filters["Description"].ToString().Replace("'", "''");
            }
            //try to get data
            try
            {
                using (BreakdownByArtCodeMngEntities context = CreateContext())
                {
                    var resultSet = context.BreakdownByArtCodeMng_function_SearchBreakdown(ArticleCode, Description, orderBy, orderDirection).ToList();
                    totalRows = resultSet.Count();
                    data.Data = converter.DB2DTO_BreakdownSearchResult(resultSet.Skip(pageSize * (pageIndex - 1)).Take(pageSize).ToList());
                }
            }
            catch (Exception ex)
            {
