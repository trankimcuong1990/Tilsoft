...
namespace Module.FactoryInvoiceMng
{
    internal class BLL
    {
        ...
        public List<DTO.BookingSearchResult> QuickSearchBooking(int iRequesterID, int supplierId, string query, out Library.DTO.Notification notification)
        {
            return factory.QuickSearchBooking(iRequesterID, supplierId, query, out notification);
        }

        public DTO.EditFormData GetData(int iRequesterID, int id, int bookingID, int supplierID, string season, out Library.DTO.Notification notification)
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, id, "get factory invoice");
            return factory.GetData(iRequesterID, id, bookingID, supplierID, season, out notification);
        }
