...
namespace Module.CheckListGroupMng
{
    public class Executor : Library.Base.IExecutor
    {
        ...
        //public bool GetEditSupport(int userId, int id, ref object dtoItem, out Library.DTO.Notification notification)
        //{
        //    return bll.GetEditSupport(userId, id, ref dtoItem, out notification);
        //}
