...
namespace Module.CheckListGroupMng
{
    internal class BLL
    {
        ...
        //public bool GetEditSupport(int iRequesterID, int id, ref object dtoItem, out Library.DTO.Notification notification)
        //{
        //    return factory.GetEditSupport(iRequesterID, id, ref dtoItem, out notification);
        //}
