...
namespace TilsoftService.Controllers
{
    ...
    {
        private string moduleCode = "MaterialTypeMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.MaterialTypeMng.Executor, Module.MaterialTypeMng");
        [HttpPost]
        [Route("gets")]
