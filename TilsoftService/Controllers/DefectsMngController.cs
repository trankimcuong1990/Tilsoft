...
namespace TilsoftService.Controllers
{
    ...
    public class DefectsMngController : ApiController
    {
		private string moduleCode = "DefectsMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.DefectsMng.Executor, Module.DefectsMng");
