...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/clientpaymentoverview")]
    public class ClientPaymentOverviewRptController : ApiController
    {
        private string moduleCode = "ClientPaymentOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ClientPaymentOverviewRpt.Executor, Module.ClientPaymentOverviewRpt");
