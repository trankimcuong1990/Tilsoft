...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/framematerialprofile")]
    public class FrameMaterialProfileController : ApiController
    {
        private string moduleCode = "FrameMaterialProfileMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FrameMaterialProfileMng.Executor, Module.FrameMaterialProfileMng");
