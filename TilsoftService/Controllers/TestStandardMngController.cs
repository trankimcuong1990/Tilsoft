...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/teststandardmng")]
    public class TestStandardMngController : ApiController
    {
        private string ModuleCode = "TestStandardMng";
        readonly Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.TestStandardMng.Executor, Module.TestStandardMng");
