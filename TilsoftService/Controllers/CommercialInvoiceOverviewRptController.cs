...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/commercialinvoiceoverview")]
    public class CommercialInvoiceOverviewRptController : ApiController
    {
        private string moduleCode = "CommercialInvoiceOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.CommercialInvoiceOverviewRpt.Executor, Module.CommercialInvoiceOverviewRpt");
