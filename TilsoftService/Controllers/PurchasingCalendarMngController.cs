...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/purchasingcalendarmng")]
    public class PurchasingCalendarMngController : ApiController
    {
        private string moduleCode = "PurchasingCalendarMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.PurchasingCalendarMng.Executor, Module.PurchasingCalendarMng");
        ...
        [HttpGet]
        [Route("quicksearchfactoryrawmaterial")]
        public IHttpActionResult QuickSearchClient(string query)
        {
            Library.DTO.Notification notification;
            Hashtable input = new Hashtable();
            input["query"] = query;
            object data = executor.CustomFunction(ControllerContext.GetAuthUserId(), "searchfactoryrawmaterial", input, out notification);
            return Ok(data);
        }
    }
}
