...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/ReceivingNoteRepairAssemblyMng")]
    public class ReceivingNoteRepairAssemblyMngController : ApiController
    {
        private string moduleCode = "ReceivingNoteRepairAssemblyMng";
        ...
        [HttpPost]
        [Route("get")]
        public IHttpActionResult Get(int id/*, int? workOrderID, int? opSequenceID*/)
        {
            //authentication
            if (!fwBll.CanPerformAction(ControllerContext.GetAuthUserId(), moduleCode, Library.DTO.ModuleAction.CanRead))
            {
