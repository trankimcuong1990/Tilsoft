namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/productionteam")]
    public class ProductionTeamController : ApiController
    {
        const string ModuleCode = "ProductionTeam";
        readonly Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductionTeam.Executor, Module.ProductionTeam");
