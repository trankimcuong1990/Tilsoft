...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/catalogfile")]
    public class CatalogFileMngController : ApiController
    {
        private string moduleCode = "CatalogFileMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.CatalogFileMng.Executor, Module.CatalogFileMng");
