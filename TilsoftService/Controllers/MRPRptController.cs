...
{
    [Authorize]
    [RoutePrefix("api/mrprpt")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class MRPRptController : ApiController
    {
		private string moduleCode = "MRPRpt";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.MRPRpt.Executor, Module.MRPRpt");
