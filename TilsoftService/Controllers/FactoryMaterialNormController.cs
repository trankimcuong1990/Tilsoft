...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factoryMaterialNorm")]
    public class FactoryMaterialNormController : ApiController
    {
        private string moduleCode = "FactoryMaterialNormMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryMaterialNorm.Executor, Module.FactoryMaterialNorm");
