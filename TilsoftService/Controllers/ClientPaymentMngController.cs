...
namespace TilsoftService.Controllers
{
    ...
    public class ClientPaymentMngController : ApiController
    {
        private string moduleCode = "ClientPaymentMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ClientPaymentMng.Executor, Module.ClientPaymentMng");
        ...
        [HttpPost]
        [Route("get")]
        public IHttpActionResult Get(string c, int m, int clientId, int id)
        {
            // authentication
            if (!fwBll.CanPerformAction(ControllerContext.GetAuthUserId(), moduleCode, Library.DTO.ModuleAction.CanRead))
            {
