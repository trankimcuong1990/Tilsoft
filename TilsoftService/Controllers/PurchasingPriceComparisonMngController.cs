...
{
    [Authorize]
    [RoutePrefix("api/purchasingpricecomparison")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class PurchasingPriceComparisonMngController : ApiController
    {
        private string moduleCode = "PurchasingPriceComparisonMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.PurchasingPriceComparisonMng.Executor, Module.PurchasingPriceComparisonMng");
        ...
        public IHttpActionResult GetReportData(string season)
        {
            ...
            object data = executor.CustomFunction(ControllerContext.GetAuthUserId(), "getreportdata", filters, out Library.DTO.Notification notification);
