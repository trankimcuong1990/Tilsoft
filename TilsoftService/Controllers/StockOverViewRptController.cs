...
{
    [Authorize]
    [RoutePrefix("api/stockoverview")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class StockOverViewRptController : ApiController
    {
		private string moduleCode = "StockOverViewRpt";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.StockOverviewRpt.Executor, Module.StockOverviewRpt");
        ...
        public IHttpActionResult GetExcelData(DTO.Search searchInput)
        {
            object data = executor.CustomFunction(ControllerContext.GetAuthUserId(), "getexcelreport", searchInput.Filters, out Library.DTO.Notification notification);
            return Ok(new Library.DTO.ReturnData<object>() { Data = data, Message = notification });
        }
    }
}
