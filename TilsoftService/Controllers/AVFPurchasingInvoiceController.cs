...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/avfpurchasinginvoice")]
    public class AVFPurchasingInvoiceController : ApiController
    {
        private string moduleCode = "AVFPurchasingInvoiceMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.AVFPurchasingInvoiceMng.Executor, Module.AVFPurchasingInvoiceMng");
