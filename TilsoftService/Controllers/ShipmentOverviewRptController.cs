...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/shipmentoverviewrpt")]
    public class ShipmentOverviewRptController : ApiController
    {
        private string moduleCode = "ShipmentOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ShipmentOverviewRpt.Executor, Module.ShipmentOverviewRpt");
