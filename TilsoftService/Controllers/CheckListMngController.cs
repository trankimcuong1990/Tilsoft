...
{
    [Authorize]
    [RoutePrefix("api/check-list")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class CheckListMngController : ApiController
    {
		private string moduleCode = "CheckListMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.CheckListMng.Executor, Module.CheckListMng");
        ...
        public IHttpActionResult GetEditSupport(int id, object dtoItem)
        {
            // authentication
            if (id > 0 && !fwBll.CanPerformAction(ControllerContext.GetAuthUserId(), moduleCode, Library.DTO.ModuleAction.CanApprove))
            {
