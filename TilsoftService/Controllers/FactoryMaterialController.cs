...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factoryMaterial")]
    public class FactoryMaterialController : ApiController
    {
        private string moduleCode = "FactoryMaterialMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryMaterial.Executor, Module.FactoryMaterial");
        ...
        [HttpPost]
        [Route("printfactorymaterialstock")]
        public IHttpActionResult PrintFactoryMaterialStock()
        {
            // authentication
            ...
            string dataFileName = executor.CustomFunction(ControllerContext.GetAuthUserId(), "PrintFactoryMaterialStock", inputs, out notification).ToString();
