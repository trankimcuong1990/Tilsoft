...
{
    [Authorize]
    [RoutePrefix("api/defectsgroup")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class DefectsGroupMngController : ApiController
    {
		private string moduleCode = "DefectsGroupMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.DefectsGroupMng.Executor, Module.DefectsGroupMng");
