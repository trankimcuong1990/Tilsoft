...
{
    [Authorize]
    [RoutePrefix("api/production-summary")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class ProductionSummaryRptController : ApiController
    {
		private readonly string moduleCode = "ProductionSummaryRpt";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductionSummaryRpt.Executor, Module.ProductionSummaryRpt");
