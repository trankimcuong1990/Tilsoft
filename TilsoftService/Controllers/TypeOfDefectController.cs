...
{
    [Authorize]
    [RoutePrefix("api/typeofdefect")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class TypeOfDefectController : ApiController
    {
		private string moduleCode = "TypeOfDefect";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.TypeOfDefectMng.Executor, Module.TypeOfDefectMng");
