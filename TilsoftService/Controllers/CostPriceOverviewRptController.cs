...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/costpriceoverview")]
    public class CostPriceOverviewRptController : ApiController
    {
        private string moduleCode = "CostPriceOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.CostPriceOverviewRpt.Executor, Module.CostPriceOverviewRpt");
