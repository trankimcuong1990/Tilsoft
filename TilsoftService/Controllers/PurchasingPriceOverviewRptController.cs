...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/purchasingpriceoverviewrpt")]
    public class PurchasingPriceOverviewRptController : ApiController
    {
        private string moduleCode = "PurchasingPriceOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.PurchasingPriceOverviewRpt.Executor, Module.PurchasingPriceOverviewRpt");
