...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/pricelistfile")]
    public class PriceListFileController : ApiController
    {
        private string moduleCode = "PriceListFile";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.PriceListFile.Executor, Module.PriceListFile");
