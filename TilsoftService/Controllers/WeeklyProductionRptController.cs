...
{
    [Authorize]
    [RoutePrefix("api/weeklyproductionrpt")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class WeeklyProductionRptController : ApiController
    {
        private string moduleCode = "WeeklyProductionRpt";
        private Library.Base.IExecutor2 executor = Library.Helper.GetDynamicObject2("Module.WeeklyProductionRpt.Executor, Module.WeeklyProductionRpt");
