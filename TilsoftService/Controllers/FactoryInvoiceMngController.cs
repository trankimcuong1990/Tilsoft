...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factoryinvoice")]
    public class FactoryInvoiceMngController : ApiController
    {
        private string moduleCode = "FactoryInvoiceMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryInvoiceMng.Executor, Module.FactoryInvoiceMng");
        ...
        public IHttpActionResult QuickSearchBooking(int? supplierid, string query)
        {
        ...
        [HttpPost]
        [Route("get")]
        public IHttpActionResult Get(int id, int b, int s, string se)
        {
            // authentication
            if (!fwBll.CanPerformAction(ControllerContext.GetAuthUserId(), moduleCode, Library.DTO.ModuleAction.CanRead))
            {
