...
{
    [Authorize]
    [RoutePrefix("api/showroomTransferMng")]
    [Lib.LogFilterAtrribute]
    public class ShowroomTransferController : ApiController
    {
        private readonly string moduleCode = "ShowroomTransferMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ShowroomTransferMng.Executor, Module.ShowroomTransferMng");
