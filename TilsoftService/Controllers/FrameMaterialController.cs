...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/framematerial")]
    public class FrameMaterialController : ApiController
    {
        private string moduleCode = "FrameMaterialMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FrameMaterialMng.Executor, Module.FrameMaterialMng");
