...
namespace TilsoftService.Controllers
{
    ...
    {
        private string moduleCode = "PriceListMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.PriceList.Executor, Module.PriceList");
