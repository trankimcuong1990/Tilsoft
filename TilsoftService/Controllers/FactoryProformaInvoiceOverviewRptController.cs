...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factoryproformainvoiceoverview")]
    public class FactoryProformaInvoiceOverviewRptController : ApiController
    {
        private string moduleCode = "FactoryProformaInvoiceOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryProformaInvoiceOverviewRpt.Executor, Module.FactoryProformaInvoiceOverviewRpt");
