...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factorypaymentsummary")]
    public class FactoryPaymentSummaryRptController : ApiController
    {
        private string moduleCode = "FactoryPaymentSummaryRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryPaymentSummaryRpt.Executor, Module.FactoryPaymentSummaryRpt");
        ...
        public IHttpActionResult GetExcelReportData(string s)
        {
            // authentication
