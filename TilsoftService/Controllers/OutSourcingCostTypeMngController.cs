...
{
    [Authorize]
    [RoutePrefix("api/outsourcingcosttypemng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class OutsourcingCostTypeMngController : ApiController
    {
		private string moduleCode = "OutsourcingCostTypeMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.OutsourcingCostTypeMng.Executor, Module.OutsourcingCostTypeMng");
