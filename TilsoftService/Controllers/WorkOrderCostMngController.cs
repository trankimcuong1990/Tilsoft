...
{
    [Authorize]
    [RoutePrefix("api/WorkOrderCost")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class WorkOrderCostMngController : ApiController
    {
		private string moduleCode = "WorkOrderCostMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.WorkOrderCostMng.Executor, Module.WorkOrderCostMng");
        ...
        [HttpPost]
        [Route("getProductionItemTypeCost")]
