...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/avfoutwardinvoice")]
    public class AVFOutwardInvoiceController : ApiController
    {
        private string moduleCode = "AVFOutwardInvoiceMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.AVFOutwardInvoiceMng.Executor, Module.AVFOutwardInvoiceMng");
