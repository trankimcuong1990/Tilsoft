...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/report_shipmentamount_vn")]
    public class ReportShipmentAmountVNController : ApiController
    {
        private string moduleCode = "ReportShipmentAmountVNMng";

        [HttpPost]
        [Route("getreport")]
        public IHttpActionResult GetShipmentAmountVN(string season)
        {
            ...
            string reportFileName = bll.GetShipmentAmountVN(season,out notification);
