...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/OrganigramMng")]
    public class OrganigramMngController : ApiController
    {
        private string moduleCode = "OrganigramMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.OrganigramMng.Executor, Module.OrganigramMng");
