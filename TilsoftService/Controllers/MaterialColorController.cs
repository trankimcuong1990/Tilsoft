...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/materialcolor")]
    public class MaterialColorController : ApiController
    {
        private string moduleCode = "MaterialColorMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.MaterialColorMng.Executor, Module.MaterialColorMng");
