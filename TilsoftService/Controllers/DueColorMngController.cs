...
{
    [Authorize]
    [RoutePrefix("api/duecolorMng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class DueColorMngController : ApiController
    {
		private string moduleCode = "DueColorMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.DueColorMng.Executor, Module.DueColorMng");
