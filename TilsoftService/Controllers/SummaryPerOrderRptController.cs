...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/summaryperorder")]
    public class SummaryPerOrderRptController : ApiController
    {
        private string moduleCode = "SummaryPerOrderRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.SummaryPerOrderRpt.Executor, Module.SummaryPerOrderRpt");
