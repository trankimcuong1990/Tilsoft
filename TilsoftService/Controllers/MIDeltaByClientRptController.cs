...
{
    [Authorize]
    [RoutePrefix("api/mi-delta-by-client")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class MIDeltaByClientRptController : ApiController
    {
		private string moduleCode = "MIDeltaByClientRpt";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.MIDeltaByClientRpt.Executor, Module.MIDeltaByClientRpt");
