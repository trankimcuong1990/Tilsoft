...
{
    [Authorize]
    [RoutePrefix("api/eurofarsamplecollectionmng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class EurofarSampleCollectionMngController : ApiController
    {
		private string moduleCode = "EurofarSampleCollectionMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.EurofarSampleCollectionMng.Executor, Module.EurofarSampleCollectionMng");
        ...
        public IHttpActionResult ExportExcelEmployee(DTO.Search searchInput)
        {
            ...
            object data = executor.CustomFunction(ControllerContext.GetAuthUserId(), "exportexcel", searchInput.Filters, out Library.DTO.Notification notification);
            return Ok(new Library.DTO.ReturnData<object>() { Data = data, Message = notification });
        }
    }
}
