...
{
    [Authorize]
    [RoutePrefix("api/outsourcingcostmng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class OutsourcingCostMngController : ApiController
    {
		private string moduleCode = "OutsourcingCostMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.OutsourcingCostMng.Executor, Module.OutsourcingCostMng");
