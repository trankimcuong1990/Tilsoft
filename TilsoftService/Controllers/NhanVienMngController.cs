...
{
    [Authorize]
    [RoutePrefix("api/nhan-vien-mng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class NhanVienMngController : ApiController
    {
		private string moduleCode = "NhanVienMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.NhanVienMng.Executor, Module.NhanVienMng");
