...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/salepriceoverviewrpt")]
    public class SalePriceOverviewRptController : ApiController
    {
        private string moduleCode = "SalePriceOverviewRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.SalePriceOverviewRpt.Executor, Module.SalePriceOverviewRpt");
