...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/report_rapeu")]
    public class ReportRAPEUController : ApiController
    {
        private string moduleCode = "ReportRAPEUMng";
        ...
        public IHttpActionResult GetReportRAPEU(string season, int factoryID)
        {
            ...
            string reportFileName = bll.GetReportRAPEU(true,season,factoryID, ControllerContext.GetAuthUserId(), out notification);
