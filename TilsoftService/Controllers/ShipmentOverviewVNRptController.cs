...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/shipmentoverviewvnrpt")]
    public class ShipmentOverviewVNRptController : ApiController
    {
        private string moduleCode = "ShipmentOverviewVNRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ShipmentOverviewVNRpt.Executor, Module.ShipmentOverviewVNRpt");
