...
{
    [Authorize]
    [RoutePrefix("api/supplierpaymenttermmng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class SupplierPaymentTermMngController : ApiController
    {
		private string moduleCode = "SupplierPaymentTermMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.SupplierPaymentTermMng.Executor, Module.SupplierPaymentTermMng");
