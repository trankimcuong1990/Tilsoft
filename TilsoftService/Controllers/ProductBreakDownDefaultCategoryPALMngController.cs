...
{
    [Authorize]
    [RoutePrefix("api/productbreakdowndefaultcategory-pal")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class ProductBreakDownDefaultCategoryPALMngController : ApiController
    {
        ...
        public IHttpActionResult GetInitData()
        {
            ...
            object data = executor.CustomFunction(ControllerContext.GetAuthUserId(), "getinitdata", filters, out Library.DTO.Notification notification);
