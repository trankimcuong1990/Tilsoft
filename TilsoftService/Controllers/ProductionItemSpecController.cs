...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/productionItemSpec")]
    public class ProductionItemSpecController : ApiController
    {
        private string moduleCode = "ProductionItemSpec";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductionItemSpec.Executor, Module.ProductionItemSpec");
