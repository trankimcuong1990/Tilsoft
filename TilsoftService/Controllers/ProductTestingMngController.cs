...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/producttestingmng")]
    public class ProductTestingMngController : ApiController
    {
        private string ModuleCode = "ProductTestingMng";
        readonly Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductTestingMng.Executor, Module.ProductTestingMng");
