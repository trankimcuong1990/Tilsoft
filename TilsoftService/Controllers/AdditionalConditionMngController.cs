...
{
    [Authorize]
    [RoutePrefix("api/additionalcondition")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class AdditionalConditionMngController : ApiController
    {
		private string moduleCode = "AdditionalConditionMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.AdditionalConditionMng.Executor, Module.AdditionalConditionMng");
