...
{
    [Authorize]
    [RoutePrefix("api/complianceCertificateType")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class ComplianceCertificateTypeController : ApiController
    {
		private string moduleCode = "ComplianceCertificateTypeMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ComplianceCertificateTypeMng.Executor, Module.ComplianceCertificateTypeMng");
