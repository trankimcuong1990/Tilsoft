...
{
    [Authorize]
    [RoutePrefix("api/VanPhatMng")]
    [TilsoftService.Lib.LogFilterAtrribute]
    public class VanPhatMngController : ApiController
    {
		private string moduleCode = "VanPhatMng";
		private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.VanPhatMng.Executor, Module.VanPhatMng");
        ...
        public IHttpActionResult GetDeliveryNotePrintoutHTML(string deliveryNoteID)
        {
