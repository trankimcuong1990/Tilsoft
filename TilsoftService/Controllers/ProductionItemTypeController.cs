...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/productionItemType")]
    public class ProductionItemTypeController : ApiController
    {
        private string moduleCode = "ProductionItemType";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductionItemType.Executor, Module.ProductionItemType");
