...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/FactoryOrderNorm")]
    public class FactoryOrderNormController : ApiController
    {
        private string moduleCode = "FactoryOrderNormMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryOrderNorm.Executor, Module.FactoryOrderNorm");
