...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factorycreditnote")]
    public class FactoryCreditNoteMngController : ApiController
    {
        private string moduleCode = "FactoryCreditNoteMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryCreditNoteMng.Executor, Module.FactoryCreditNoteMng");
        ...
        public IHttpActionResult QuickSearchInvoice(int? supplierid, string season, string query)
        {
