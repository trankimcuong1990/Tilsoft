...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/costinvoice2creditormng")]
    public class CostInvoice2CreditorMngController : ApiController
    {
        const string ModuleCode = "CostInvoice2CreditorMng";
        readonly Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.CostInvoice2CreditorMng.Executor, Module.CostInvoice2CreditorMng");
