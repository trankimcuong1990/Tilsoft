...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/factoryStepNorm")]
    public class FactoryStepNormController : ApiController
    {
        private string moduleCode = "FactoryStepNormMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactoryStepNorm.Executor, Module.FactoryStepNorm");
