...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/ledgeraccount")]
    public class LedgerAccountMngController : ApiController
    {
        private string moduleCode = "LedgerAccountMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.LedgerAccountMng.Executor, Module.LedgerAccountMng");
        ...
        public IHttpActionResult GetDetailOverview(string accountNo)
        {
            // authentication
            if (!fwBll.CanPerformAction(ControllerContext.GetAuthUserId(), moduleCode, Library.DTO.ModuleAction.CanRead))
            {
