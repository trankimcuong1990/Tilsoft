...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/FactorySalesQuotationMng")]
    public class FactorySaleQuotationMngController : ApiController
    {
        // GET: FactorySaleQuotationMng
        private string moduleCode = "FactorySalesQuotationMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.FactorySalesQuotationMng.Executor, Module.FactorySalesQuotationMng");
