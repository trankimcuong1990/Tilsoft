...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/productionItemGroup")]
    public class ProductionItemGroupController : ApiController
    {
        private string moduleCode = "ProductionItemGroup";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.ProductionItemGroup.Executor, Module.ProductionItemGroup");
