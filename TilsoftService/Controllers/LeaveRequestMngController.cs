...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/leaverequestmng")]
    public class LeaveRequestMngController : ApiController
    {
        private string moduleCode = "LeaveRequestMng";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.LeaveRequestMng.Executor, Module.LeaveRequestMng");
