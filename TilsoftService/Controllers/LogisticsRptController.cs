...
namespace TilsoftService.Controllers
{
    ...
    [RoutePrefix("api/logisticsrpt")]

    public class LogisticsRptController : ApiController
    {
        private string moduleCode = "LogisticsRpt";
        private Library.Base.IExecutor executor = Library.Helper.GetDynamicObject("Module.LogisticsRpt.Executor, Module.LogisticsRpt");
