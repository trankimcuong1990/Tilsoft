...
namespace DAL.MaterialOptionMng
{
    ...
    public partial class MaterialOptionMng_MaterialOption_View
    {
        public MaterialOptionMng_MaterialOption_View()
        {
            this.MaterialOptionMng_MaterialOptionProductGroup_View = new HashSet<MaterialOptionMng_MaterialOptionProductGroup_View>();
        ...
        public virtual ICollection<MaterialOptionMng_MaterialOptionProductGroup_View> MaterialOptionMng_MaterialOptionProductGroup_View { get; set; }
