...
namespace DTO.ECommercialInvoiceMng
{
    public class ECommercialInvoice
    {
         ...
         * LIST FIELD
         */
        public List<ECommercialInvoiceDetail> ECommercialInvoiceDetails { get; set; }
        public List<ECommercialInvoiceExtDetail> ECommercialInvoiceExtDetails { get; set; }
        public List<ECommercialInvoiceDescription> ECommercialInvoiceDescriptions { get; set; }
        public List<ECommercialInvoiceSparepartDetail> ECommercialInvoiceSparepartDetails { get; set; }
        public List<ECommercialInvoiceContainerTransport> ECommercialInvoiceContainerTransports { get; set; }
        public List<ECommercialInvoiceSampleDetail> ECommercialInvoiceSampleDetails { get; set; }
        public List<Booking> Bookings { get; set; }
        public List<CreditNote> CreditNotes { get; set; }
        public List<WarehouseInvoiceProductDetail> WarehouseInvoiceProductDetails { get; set; }
        public List<WarehouseInvoiceSparepartDetail> WarehouseInvoiceSparepartDetails { get; set; }
        public List<WarehouseImport> WarehouseImports { get; set; }
