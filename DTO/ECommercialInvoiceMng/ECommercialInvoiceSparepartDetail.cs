...
{
    public class ECommercialInvoiceSparepartDetail
    {
        ...
        public List<DTO.ECommercialInvoiceMng.ECommercialInvoiceSparepartDetailDescription> eCommercialInvoiceSparepartDetailDescriptions { get; set; }
    }
}