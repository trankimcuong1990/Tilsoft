...
namespace DTO.FactoryOrderMng
{
    public class FactoryOrder
    {
        ...
        public List<FactoryOrderDetail> FactoryOrderDetails { get; set; }
        public List<FactoryOrderSparepartDetail> FactoryOrderSparepartDetails { get; set; }
        public List<FactoryOrderSampleDetail> FactoryOrderSampleDetails { get; set; }
        ...
        public List<ClientComplaintLink> ListClientComplaintIDs { get; set; }
    }
}