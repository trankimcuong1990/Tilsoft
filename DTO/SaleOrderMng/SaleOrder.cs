...
namespace DTO.SaleOrderMng
{
    public class SaleOrder
    {
        ...
        public List<LDSClient> LDSClients { get; set; }
        public List<SaleOrderExtend> SaleOrderExtends { get; set; }
        public List<SaleOrderDetailSparepart> SaleOrderDetailSpareparts { get; set; }
        public List<SaleOrderDetailSample> SaleOrderDetailSamples { get; set; }
        public List<SaleOrderProductReturn> SaleOrderProductReturns { get; set; }
        public List<SaleOrderSparepartReturn> SaleOrderSparepartReturns { get; set; }
        ...
        public bool? LCFileHasChange { get; set; }
        public string NewLCFile { get; set; }
        ...
        public string LCFileURL { get; set; }
        public string LCFileFriendlyName { get; set; }
    }
}