...
namespace DTO.OfferMng
{
    public class Offer
    {
        ...
        public List<OfferLineSparepart> OfferLineSpareparts { get; set; }
        ...
        public bool? IsActiveApproveOffer { get; set; } // Checking special permission
        public bool? IsActiveApprovalOffer { get; set; } // Mapping value in db

        public string SaleUD { get; set; }
        public decimal? Delta7PercentLastYear { get; set; }
    }
}