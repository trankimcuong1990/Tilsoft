   ...
   public class Executor : Library.Base.IExecutor
    {
        ...
        public object CustomFunction(int userId, string identifier, Hashtable input, out Notification notification)
        {
            ...
            {
                case "getfilterorder":
                    return bll.GetFilterOrder(userId, searchQuery, out notification);
                case "getfilterquotation":
                    return bll.GetFilterFactoryQuotation(userId, searchQuery, out notification);
                ...
                case "getfactorysalesquotation":
                    string factorySalesQuotationUD = input["factorySalesQuotationUD"].ToString();
                    return bll.GetFactorySalesQuotation(userId, factorySalesQuotationUD, out notification);
