...
namespace Module.PreOrderPlanningOverviewRpt
{
    internal class BLL
    {
        ...
        public DTO.ReportFormData GetHTMLReport(int iRequesterID, out Library.DTO.Notification notification)
        {
            return factory.GetHTMLReport(iRequesterID, out notification);
        }
    }
}
