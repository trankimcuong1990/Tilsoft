...
namespace Module.SaleOrderMng.DAL
{
    public class DataFactoryReturnGoods
    {
        ...
        {
            return new ReturnGoodsFromSaleOrderEntities(Library.Helper.CreateEntityConnectionString("DAL.ReturnGoodsFromSaleOrderModel"));
        }

        public List<DTO.LoadingPlan2> GetLoadingPlan(int saleOrderID, out Library.DTO.Notification notification)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new List<DTO.LoadingPlan2>();
            }
        }

        public bool CreateReturnData(object dtoReturnGoods, out Library.DTO.Notification notification)
        {
            List<DTO.LoadingPlan2> dtoReturns = ((Newtonsoft.Json.Linq.JArray)dtoReturnGoods).ToObject<List<DTO.LoadingPlan2>>();
            ...
            try
            {
                using (ReturnGoodsFromSaleOrderEntities context = CreateContext())
                {
                    ...
                    dbWHImport.Season = Library.Helper.GetCurrentSeason();
