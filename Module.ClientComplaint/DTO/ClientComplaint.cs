...
namespace Module.ClientComplaint.DTO
{
    public class ClientComplaint
    {
        ...
        // Child detail
        public List<ClientComplaintUser> ClientComplaintUsers { get; set; }

        public List<ClientComplaintItem> ClientComplaintItems { get; set; }

        public List<ClientComplaintCommunication> ClientComplaintCommunications { get; set; }
