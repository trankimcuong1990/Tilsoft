...
namespace Module.MaterialTestingMng
{
    internal class BLL
    {
        ...
        public object GetMaterialOption(int userId, Hashtable filters, out Notification notification)
        {
            return factory.GetMaterialOption(filters, out notification);
        }
