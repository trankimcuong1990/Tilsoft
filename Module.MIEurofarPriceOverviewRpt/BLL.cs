...
namespace Module.MIEurofarPriceOverviewRpt
{
    internal class BLL
    {
        ...
        public DTO.HtmlReportData GetHtmlReportData(int iRequesterID, string season, out Library.DTO.Notification notification)
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get MI eurofar price overview data to excel");
        ...
        public List<DTO.SalePerformanceDTO> GetSalePerformance(int iRequesterID, string season, out Library.DTO.Notification notification)
        {
            return factory.GetSalePerformance(season, out notification);
        }
    }
}
