...
namespace DAL.ProductMng
{
    ...
    public partial class Product
    {
        public Product()
        {
            this.ProductPiece = new HashSet<ProductPiece>();
            this.ProductColliPiece = new HashSet<ProductColliPiece>();
            this.ProductSetEANCode = new HashSet<ProductSetEANCode>();
            this.ProductECommerceSpec = new HashSet<ProductECommerceSpec>();
        }
        ...
        public virtual ICollection<ProductPiece> ProductPiece { get; set; }
        public virtual ICollection<ProductColliPiece> ProductColliPiece { get; set; }
        public virtual ICollection<ProductSetEANCode> ProductSetEANCode { get; set; }
        public virtual ICollection<ProductECommerceSpec> ProductECommerceSpec { get; set; }
    }
}
