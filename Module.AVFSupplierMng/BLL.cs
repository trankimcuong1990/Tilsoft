...
namespace Module.AVFSupplierMng
{
    public class BLL
    {
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get list of supplier");
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get as supplier " + id.ToString());
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "delete as supplier " + id.ToString());
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get supplier overview data to excel");
