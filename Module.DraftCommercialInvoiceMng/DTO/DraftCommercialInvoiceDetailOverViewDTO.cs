...
{
    public class DraftCommercialInvoiceDetailOverViewDTO
    {
        ...
        public List<DraftCommercialInvoiceDetailDescriptionOverViewDTO> DraftCommercialInvoiceDetailDescriptions {get;set; }
        public DraftCommercialInvoiceDetailOverViewDTO()
        {
            DraftCommercialInvoiceDetailDescriptions = new List<DraftCommercialInvoiceDetailDescriptionOverViewDTO>();
        }
    }
}
