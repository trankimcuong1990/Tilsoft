...
namespace Module.OfferToClientMng.DTO
{
    public class OfferLineDTO
    {
        ...
        public int? OfferSeasonDetailQuantity { get; set; }
        ...
        public decimal? OfferSeasonDetailCommissionPercent { get; set; }
        ...
        public List<OfferLinePriceOptionDTO> OfferLinePriceOptionDTOs { get; set; }
        ...
        public List<PlaningPurchasingPriceDTO> PlaningPurchasingPriceDTOs { get; set; }
        ...
        public int IsSparePart { get; set; }
