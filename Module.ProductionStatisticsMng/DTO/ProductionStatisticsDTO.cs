...
namespace Module.ProductionStatisticsMng.DTO
{
    ...
    {
        public ProductionStatisticsDTO()
        {
            ProductionStatisticsDetailDTOs = new List<ProductionStatisticsDetailDTO>();
        }
        ...
        public List<ProductionStatisticsDetailDTO> ProductionStatisticsDetailDTOs { get; set; }
    }
}
