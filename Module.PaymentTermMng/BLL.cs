...
namespace Module.PaymentTermMng
{
    internal class BLL
    {
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get list of Payment Term");
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "get as Payment Term" + id.ToString());
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "delete as Payment Term" + id.ToString());
        ...
        {
            // keep log entry
            fwBLL.WriteLog(iRequesterID, 0, "update Payment Term" + id.ToString());
