...
{
    public class QualityInspectionData
    {
        public QualityInspectionData()
        {
            QualityInspectionCategories = new List<QualityInspectionCategoryData>();
        }
        ...
        public List<QualityInspectionCategoryData> QualityInspectionCategories { get; set; }
    }
}
