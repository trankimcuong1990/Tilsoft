        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            switch (identifier.ToLower())
            {
                ...
                case "searchinvoice":
                    ...
                    return bll.QuickSearchInvoice(userId, Convert.ToInt32(input["supplierid"]), input["season"].ToString(), input["query"].ToString(), out notification);
                ...
                case "getdata":
                    ...
                    return bll.GetData(userId, Convert.ToInt32(input["id"]), Convert.ToInt32(input["supplierid"]), input["season"].ToString(), out notification);
            }
