...
namespace Module.SampleItemMng.DTO
{
    public class SampleProductDTO
    {
        ...
        public FactoryBreakdownDTO FactoryBreakdownDTO { get; set; }
        public List<SampleProgressDTO> SampleProgressDTOs { get; set; }
        public List<SampleQARemarkDTO> SampleQARemarkDTOs { get; set; }        
    }
}
