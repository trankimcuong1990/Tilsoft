...
namespace Module.VanPhatMng
{
    internal class BLL
    {
        ...
        public object GetDetailProductionItemList(int userId, System.Collections.Hashtable filters, out Library.DTO.Notification notification)
        {
            return factory.GetDetailProductionItemList( filters, out notification);
        }

        public DTO.VPPrintOutDTO GetDeliveryNotePrintoutHTML (int userId, System.Collections.Hashtable filters, out Library.DTO.Notification notification)
        {
            return factory.GetDeliveryNotePrintoutHTML(filters, out notification);
        }
    }
}
