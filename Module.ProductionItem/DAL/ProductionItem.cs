...
namespace Module.ProductionItem.DAL
{
    ...
    public partial class ProductionItem
    {
        ...
        {
            this.ProductionItemVender = new HashSet<ProductionItemVender>();
            this.ProductionItemWarehouse = new HashSet<ProductionItemWarehouse>();
            this.ProductionItemUnit = new HashSet<ProductionItemUnit>();
        }
        ...
        public virtual ICollection<ProductionItemVender> ProductionItemVender { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ProductionItemWarehouse> ProductionItemWarehouse { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ProductionItemUnit> ProductionItemUnit { get; set; }
    }
}
