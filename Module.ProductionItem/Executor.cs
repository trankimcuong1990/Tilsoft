        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            switch (identifier.ToLower())
            {
                ...
                case "exportexcel":
                    ...
                    return bll.ExportExcelReportData(userId, Convert.ToInt32(input["ID"]), out notification);

                case "exportexcellistproductionitem":                   
                    return bll.GetProductionItemExportToExcelList(userId, input, out notification);
