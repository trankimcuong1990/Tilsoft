...
namespace Module.NotificationMessageMng.DAL
{
    internal class DataFactory : Library.Base.DataFactory<DTO.SearchFormData, DTO.EditFormData>
    {
        ...
        private NotificationMessageMngEntities CreateContext()
        {
            return new NotificationMessageMngEntities(Library.Helper.CreateEntityConnectionString("DAL.NotificationMessageMngModel"));
        }
