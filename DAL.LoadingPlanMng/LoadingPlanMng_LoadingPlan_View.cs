...
namespace DAL.LoadingPlanMng
{
    ...
    public partial class LoadingPlanMng_LoadingPlan_View
    {
        public LoadingPlanMng_LoadingPlan_View()
        {
            this.LoadingPlanMng_LoadingPlanSparepartDetail_View = new HashSet<LoadingPlanMng_LoadingPlanSparepartDetail_View>();
            this.LoadingPlanMng_ChildLoadingPlan_View = new HashSet<LoadingPlanMng_ChildLoadingPlan_View>();
            this.LoadingPlanMng_LoadingPlanDetail_View = new HashSet<LoadingPlanMng_LoadingPlanDetail_View>();
            this.LoadingPlanMng_LoadingPlanSampleDetail_View = new HashSet<LoadingPlanMng_LoadingPlanSampleDetail_View>();
        }
        ...
        public virtual ICollection<LoadingPlanMng_LoadingPlanSparepartDetail_View> LoadingPlanMng_LoadingPlanSparepartDetail_View { get; set; }
        public virtual ICollection<LoadingPlanMng_ChildLoadingPlan_View> LoadingPlanMng_ChildLoadingPlan_View { get; set; }
        public virtual ICollection<LoadingPlanMng_LoadingPlanDetail_View> LoadingPlanMng_LoadingPlanDetail_View { get; set; }
        public virtual ICollection<LoadingPlanMng_LoadingPlanSampleDetail_View> LoadingPlanMng_LoadingPlanSampleDetail_View { get; set; }
    }
}
