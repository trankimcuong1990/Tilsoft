    ...
    public class Executor : Library.Base.IExecutor
    {
        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            ...
            switch (identifier.Trim().ToLower())
            {
                ...
                case "getreportdata-for-delta-overview":
                    return bll.GetReportData_ForDeltaOverview(userId, input["Season"].ToString(), out notification);
                case "get-piconfirmed-by-itemcategory":
                    return bll.GetPiConfirmedByItemCategory(input["Season"].ToString(), out notification);
                default:
