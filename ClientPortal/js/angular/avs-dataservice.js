angular.module('cpApp').service('avsDataService', ['$http', function ($http) {
    this.searchFilter = {
        filters: {},
    ...
    this.gridHandler = {
        loadMore: function () {
            if (this.pageIndex < this.totalPage) {
                this.pageIndex++;
                this.search(this.pageIndex, null, null);
            }
        },
        sort: function (sortedBy, sortedDirection) {
            this.pageIndex = 1;
            this.search(this.pageIndex, sortedBy, sortedDirection);
        },
        search: function (pageIndex, sortedBy, sortedDirection) { },
        saveState: function (totalRows, pageSize) {
