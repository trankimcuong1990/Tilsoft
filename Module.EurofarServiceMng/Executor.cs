...
namespace Module.EurofarServiceMng
{
    public class Executor : Library.Base.IExecutor
    {
        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable filters, out Library.DTO.Notification notification)
        {
            ...
            {
                case "GetWarehousePhysicalStock":
                    return bll.GetWarehousePhysicalStock(out notification);

                case "GetWarehouseReservationStockByNLBL":
                    return bll.GetWarehouseReservationStockByNLBL(out notification);
