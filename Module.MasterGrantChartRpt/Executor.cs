...
namespace Module.MasterGrantChartRpt
{
    public class Executor : Library.Base.IExecutor
    {
        ...
        public object CustomFunction(int userId, string identifier, System.Collections.Hashtable input, out Library.DTO.Notification notification)
        {
            ...
            {
                case "get-work-order-production-detail":
                    int workOrderID = Convert.ToInt32(input["workOrderID"]);
                    return bll.GetWorkOrderProductionDetail(workOrderID, userId, out notification);
