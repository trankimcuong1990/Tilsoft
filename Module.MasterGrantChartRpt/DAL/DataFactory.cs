...
namespace Module.MasterGrantChartRpt.DAL
{
    internal class DataFactory : Library.Base.DataFactory<DTO.SearchFormData, DTO.EditFormData>
    {
        ...
        private MasterGrantChartRptEntities CreateContext()
        {
            return new MasterGrantChartRptEntities(Library.Helper.CreateEntityConnectionString("DAL.MasterGrantChartRptModel"));
        }
