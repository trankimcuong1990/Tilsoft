...
namespace Module.MasterGrantChartRpt
{
    internal class BLL
    {
        ...
        public List<DTO.WorkOrderProductionDetailDTO> GetWorkOrderProductionDetail(int workOrderID,int iRequesterID, out Library.DTO.Notification notification)
        {
            return factory.GetWorkOrderProductionDetail(workOrderID, out notification);
        }
    }
}
