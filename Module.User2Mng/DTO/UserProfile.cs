...
namespace Module.User2Mng.DTO
{
    public class UserProfile
    {
        ...
        public List<DTO.Permission> Permissions { get; set; }
        public List<DTO.EmployeeFactory> EmployeeFactories { get; set; }
        public List<DTO.FactoryAccess> FactoryAccesses { get; set; }
    }
}
