...
namespace DAL.OfferMng
{
    ...
    public partial class OfferMng_Offer_OverView
    {
        public OfferMng_Offer_OverView()
        {
            this.OfferMng_OfferLine_OverView = new HashSet<OfferMng_OfferLine_OverView>();
            this.OfferMng_OfferLineSparepart_OverView = new HashSet<OfferMng_OfferLineSparepart_OverView>();
        }
        ...
        public virtual ICollection<OfferMng_OfferLine_OverView> OfferMng_OfferLine_OverView { get; set; }
        public virtual ICollection<OfferMng_OfferLineSparepart_OverView> OfferMng_OfferLineSparepart_OverView { get; set; }
    }
}
