...
namespace DAL.OfferMng
{
    ...
    public partial class Offer
    {
        public Offer()
        {
            this.OfferStatus = new HashSet<OfferStatus>();
            this.OfferLine = new HashSet<OfferLine>();
            this.OfferLineSparepart = new HashSet<OfferLineSparepart>();
            this.OfferLineSampleProduct = new HashSet<OfferLineSampleProduct>();
        }
        ...
        public virtual ICollection<OfferStatus> OfferStatus { get; set; }
        public virtual ICollection<OfferLine> OfferLine { get; set; }
        public virtual ICollection<OfferLineSparepart> OfferLineSparepart { get; set; }
        public virtual ICollection<OfferLineSampleProduct> OfferLineSampleProduct { get; set; }
