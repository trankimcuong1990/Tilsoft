...
namespace DAL.OfferMng
{
    ...
    public partial class OfferLine
    {
        public OfferLine()
        {
            ...
            this.OfferLinePriceOption = new HashSet<OfferLinePriceOption>();
            this.OfferLineSalePriceHistory = new HashSet<OfferLineSalePriceHistory>();
        }
        ...
        public virtual ICollection<OfferLinePriceOption> OfferLinePriceOption { get; set; }
        public virtual ICollection<OfferLineSalePriceHistory> OfferLineSalePriceHistory { get; set; }
    }
}
