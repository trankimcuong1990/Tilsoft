...
namespace DAL.OfferMng
{
    ...
    public partial class OfferMng_Offer_View
    {
        public OfferMng_Offer_View()
        {
            this.OfferMng_OfferLine_View = new HashSet<OfferMng_OfferLine_View>();
            this.OfferMng_OfferLineSparepart_View = new HashSet<OfferMng_OfferLineSparepart_View>();
            this.OfferMng_OfferLineSampleProduct_View = new HashSet<OfferMng_OfferLineSampleProduct_View>();
        }
        ...
        public virtual ICollection<OfferMng_OfferLine_View> OfferMng_OfferLine_View { get; set; }
        public virtual ICollection<OfferMng_OfferLineSparepart_View> OfferMng_OfferLineSparepart_View { get; set; }
        public virtual ICollection<OfferMng_OfferLineSampleProduct_View> OfferMng_OfferLineSampleProduct_View { get; set; }
    }
}
