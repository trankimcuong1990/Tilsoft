...
namespace Module.AccManagerPerformanceRpt.DAL
{
    internal class DataFactory : Library.Base.DataFactory<DTO.SearchFormData, DTO.EditFormData>
    {
        ...
        private AccManagerPerformanceRptEntities CreateContext()
        {
            return new AccManagerPerformanceRptEntities(Library.Helper.CreateEntityConnectionString("DAL.AccManagerPerformanceRptModel"));
        }
        ...
        public DTO.SupportFormData GetInitData(int userId, out Library.DTO.Notification notification)
        {
            ...
            try
            {
                using (AccManagerPerformanceRptEntities context = CreateContext())
                {
                    ...
                    {
                        data.SaleDTOs.Add(new DTO.SaleDTO { UserID = -1, EmployeeNM = "All Account Manager" });
